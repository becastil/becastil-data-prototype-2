  ...
  return (
    <div className="min-h-screen bg-white text-black">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-black/70 max-w-3xl">
              Explore monthly claims versus budget and review how high-cost members cluster across paid-amount bands.
            </p>
          </div>
        ...
        {/* Insights Summary */}
        <div className="mt-8 border border-black/10 rounded-xl p-6 bg-white">
