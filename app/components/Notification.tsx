...
export function Notification({
  ...
  const notification = (
    <div
      className={`fixed top-4 right-4 max-w-sm w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg border ${getColorClasses()} transform transition-all duration-200 z-50 ${
  ...
  return typeof window !== 'undefined' ? createPortal(notification, document.body) : null
}
